...
config file):
	...
	HiddenServicePort 23801 127.0.0.1:23801
	HiddenServicePort 23802 127.0.0.1:23802

The directory can be different of course, but (both) port numbers should be equal to
your zerod's P2P listen port (23801 by default).
...
In a typical situation, where you're only reachable via Tor, this should suffice:
	...
	./zerod -proxy=127.0.0.1:9050 -externalip=zctestseie6wxgio.onion -listen

(obviously, replace the Onion address with your own). It should be noted that you still
listen on all devices and another node could establish a clearnet connection, when knowing
your address. To mitigate this, additionally bind the address of your Tor proxy:

	./zerod ... -bind=127.0.0.1
...
for normal IPv4/IPv6 communication, use:
	...
	./zerod -onion=127.0.0.1:9050 -externalip=zctestseie6wxgio.onion -discover
...
a single Zcash hidden server. Launch zerod as follows:

	./zerod -onion=127.0.0.1:9050 -connect=zctestseie6wxgio.onion

Now use zero-cli to verify there is only a single peer connection.

	zero-cli getpeerinfo

	[
	    {
	        "id" : 1,
	        "addr" : "zctestseie6wxgio.onion:23802",
	        ...
	        "version" : 170002,
...
To connect to multiple Tor nodes, use:
	...
	./zerod -onion=127.0.0.1:9050 -addnode=zctestseie6wxgio.onion -dnsseed=0 -onlynet=onion
