...
class NUPeerManagementTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        # Verify mininodes are still connected to pirated node
        ...
        # Mininodes send ping message to pirated node.
        pingCounter = 1
        for node in nodes:
        ...
        # Connect a new Overwinter mininode to the pirated node, which is accepted.
        ...
        # Connect a new Sapling mininode to the pirated node, which is accepted.
        ...
        # Try to connect a new Sprout mininode to the pirated node, which is rejected.
        ...
        # Try to connect a new Overwinter mininode to the pirated node, which is rejected.
