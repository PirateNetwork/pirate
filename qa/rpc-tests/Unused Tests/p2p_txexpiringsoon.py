...
class TxExpiringSoonTest(BitcoinTestFramework):
    ...
    def verify_inv(self, testnode, tx):
        ...
        # Send p2p message "mempool" to receive contents from pirated node in "inv" message
        with mininode_lock:
    ...
    def run_test(self):
        ...
        # Verify mininodes are connected to pirated nodes
        ...
        # Mininodes send expiring soon transaction in "tx" message to pirated node
        ...
        # Mininodes send transaction in "tx" message to pirated node
