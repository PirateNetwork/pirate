#!/usr/bin/env python3
#
# This script checks for updates to pirated's dependencies.
#
# The SOURCE_ROOT constant specifies the location of the pirated codebase to
# check.
#
...
def parse_token():
    ...
    if not os.path.exists(token_path):
        token_path = os.path.join(xdg.xdg_data_home(), "pirate/updatecheck/token")
    try:
