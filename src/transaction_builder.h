...
public:
    ...
    // using their own calling wallet's -changeaddress override, if any -- see the
    // instructedSaplingChangeAddr/instructedIronwoodChangeAddr member comment
    // above for why this belongs on the create side, not the sign side.
