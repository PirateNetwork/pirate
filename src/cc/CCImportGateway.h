...
std::string ImportGatewayBind(uint64_t txfee,std::string coin,uint256 oracletxid,uint8_t M,uint8_t N,std::vector<CPubKey> pubkeys,uint8_t p1,uint8_t p2,uint8_t p3,uint8_t p4,CWallet *pwallet=nullptr);
...
std::string ImportGatewayWithdraw(uint64_t txfee,uint256 bindtxid,std::string refcoin,CPubKey withdrawpub,int64_t amount,CWallet *pwallet=nullptr);
std::string ImportGatewayPartialSign(uint64_t txfee,uint256 lasttxid,std::string refcoin, std::string hex,CWallet *pwallet=nullptr);
std::string ImportGatewayCompleteSigning(uint64_t txfee,uint256 lasttxid,std::string refcoin,std::string hex,CWallet *pwallet=nullptr);
std::string ImportGatewayMarkDone(uint64_t txfee,uint256 completetxid,std::string refcoin,CWallet *pwallet=nullptr);
