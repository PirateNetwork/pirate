...
public:
    ...
    enum Bech32Type {
        ...
        SAPLING_OUTPUT_DISCLOSURE,

        IRONWOOD_PAYMENT_ADDRESS,
        IRONWOOD_FULL_VIEWING_KEY,
        IRONWOOD_EXTENDED_FVK,
        IRONWOOD_DIVERSIFIED_EXTENDED_FVK,
        IRONWOOD_EXTENDED_SPEND_KEY,
        IRONWOOD_DIVERSIFIED_EXTENDED_SPEND_KEY,
        IRONWOOD_OUTPUT_DISCLOSURE,
