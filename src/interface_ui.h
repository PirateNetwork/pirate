...
// Renamed from ui_interface.h: CMake's AUTOUIC treats any "ui_*.h" include as
// a request for a Qt Designer-generated header, which broke every non-Qt
// translation unit including this file once the build moved to CMake.

#ifndef BITCOIN_INTERFACE_UI_H
#define BITCOIN_INTERFACE_UI_H
...
public:
    ...
    /** Show message box. */
    boost::signals2::signal<int (const std::string& message, const std::string& caption, unsigned int style), boost::signals2::last_value<int> > ThreadSafeMessageBox;

    /** If possible, ask the user a question. If not, falls back to ThreadSafeMessageBox(noninteractive_message, caption, style) and returns false. */
    boost::signals2::signal<int (const std::string& message, const std::string& noninteractive_message, const std::string& caption, unsigned int style), boost::signals2::last_value<int> > ThreadSafeQuestion;
