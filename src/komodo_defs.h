...
//#define KOMODO_ORCHARD_ACTIVATION 1726848600 // 9/18/2024
#define KOMODO_ORCHARD_ACTIVATION 4294967294 //is not active yet
...
// extern int32_t ASSETCHAINS_ORCHARD, ASSETCHAINS_SAPLING, ASSETCHAINS_OVERWINTER,ASSETCHAINS_BLOCKTIME;
