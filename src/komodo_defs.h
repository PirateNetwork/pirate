...
#define KOMODO_CANOPY_ACTIVATION 4294967295 // max uint32_t value  - 2/7/2106 - Never Activate
...
// extern int32_t ASSETCHAINS_CANOPY, ASSETCHAINS_SAPLING, ASSETCHAINS_OVERWINTER,ASSETCHAINS_BLOCKTIME;
