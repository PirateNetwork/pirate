...
/***
 * This file is different between chains (i.e. mainnet and testnet) on purpose. 
 * Merging between branches should be done with care.
 */
...
/**
 * For testnet, the above should be removed, and the following should be uncommented.
 * Once the official testnet branch is created, we can check it in this way.
 */
/*
const char *Notaries_genesis[][2] =
{
