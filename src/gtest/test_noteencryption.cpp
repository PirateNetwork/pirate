...
// Sapling note decryption tests removed - decryption is now tested in Rust
// Sapling encryption API test removed - low-level encryption/decryption tested in Rust
