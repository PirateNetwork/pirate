...
public:
    ...
    //! True if any stored master key still uses the weak legacy (SHA-512) KDF and
    //! should be re-encrypted with the current memory-hard KDF.
    bool NeedsKDFUpgrade() const;
