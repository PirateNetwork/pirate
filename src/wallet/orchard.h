...
public:
    ...
    OrchardDecryptedActions(const CAmount value, const libzcash::OrchardPaymentAddressPirate address, const std::array<unsigned char, ZC_MEMO_SIZE> memo)
      : value(value), address(address), memo(memo)
    {}
    ...
    static std::optional<OrchardDecryptedActions> AttemptDecryptOchardAction(
    ...
    )
    {
        ...
        OrchardDecryptedActions ret = OrchardDecryptedActions(value_t, address_r, memo_t);
