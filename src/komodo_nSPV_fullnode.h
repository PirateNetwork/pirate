...
int32_t NSPV_getntzsproofresp(struct NSPV_ntzsproofresp *ptr,uint256 prevntztxid,uint256 nextntztxid)
{
    ...
    if ( NSPV_notarizationextract(0,ptr->prevtxidht,&ptr->common.prevht,&bhash0,&desttxid0,tx) < 0 )
        return(-2);
    ...
    if ( NSPV_notarizationextract(0,ptr->nexttxidht,&ptr->common.nextht,&bhash1,&desttxid1,tx) < 0 )
        return(-5);
