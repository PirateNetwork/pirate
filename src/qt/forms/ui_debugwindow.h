...
public:
    ...
    void setupUi(QWidget *RPCConsole)
    {
        ...
        verticalLayout_7 = new QVBoxLayout(tab_peers);
        ...
        verticalLayout_101 = new QVBoxLayout(widget_1);
        ...
        verticalLayout_6->addWidget(peerHeading);
        ...
        detailWidget->setGeometry(QRect(0, 0, 316, 455));
        ...
        gridLayout_3->addWidget(peerMappedAS, 18, 2, 1, 1);
        ...
        gridLayout_3->addWidget(peerMappedASLabel, 18, 0, 1, 1);
        ...
        verticalSpacer_3 = new QSpacerItem(75, 14, QSizePolicy::Minimum, QSizePolicy::Expanding);

        gridLayout_3->addItem(verticalSpacer_3, 19, 0, 1, 1);
    ...
    void retranslateUi(QWidget *RPCConsole)
    {
        ...
        peerMappedAS->setText(QApplication::translate("RPCConsole", "N/A", Q_NULLPTR));
...
#ifndef QT_NO_TOOLTIP
        peerMappedASLabel->setToolTip(QApplication::translate("RPCConsole", "The mapped Autonomous System used for diversifying peer selection.", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        peerMappedASLabel->setText(QApplication::translate("RPCConsole", "Mapped AS", Q_NULLPTR));
