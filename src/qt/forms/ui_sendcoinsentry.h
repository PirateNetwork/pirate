...
public:
    ...
    KomodoAmountField *payAmount_is;
    ...
    void setupUi(QStackedWidget *SendCoinsEntry)
    {
        ...
        horizontalLayoutAmount->setSpacing(10);
        horizontalLayoutAmount->setObjectName(QStringLiteral("horizontalLayoutAmount"));
        payAmount = new KomodoAmountField(SendCoins);
        ...
        QIcon icon3;
        icon3.addFile(QStringLiteral(":/icons/all_balance"), QSize(), QIcon::Normal, QIcon::Off);
        useAvailableBalanceButton->setIcon(icon3);
        ...
        payAmount_is = new KomodoAmountField(SendCoins_UnauthenticatedPaymentRequest);
        ...
        payAmount_s = new KomodoAmountField(SendCoins_AuthenticatedPaymentRequest);
...
#ifndef QT_NO_TOOLTIP
        payTo->setToolTip(QApplication::translate("SendCoinsEntry", "The Komodo address to send the payment to", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
#ifndef QT_NO_TOOLTIP
...
#ifndef QT_NO_TOOLTIP
        addAsLabel->setToolTip(QApplication::translate("SendCoinsEntry", "Enter a label for this address to add it to the list of used addresses (only for taddrs)", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        amountLabel->setText(QApplication::translate("SendCoinsEntry", "A&mount:", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        checkboxSubtractFeeFromAmount->setToolTip(QApplication::translate("SendCoinsEntry", "The fee will be deducted from the amount being sent. The recipient will receive less coins than you enter in the amount field. If multiple recipients are selected, the fee is split equally.", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
...
#ifndef QT_NO_TOOLTIP
        messageTextLabel->setToolTip(QApplication::translate("SendCoinsEntry", "A message that was attached to the komodo: URI which will be stored with the transaction for your reference. Note: This message will not be sent over the Komodo network.", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
#ifndef QT_NO_TOOLTIP
