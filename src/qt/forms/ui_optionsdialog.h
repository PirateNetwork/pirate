...
public:
    ...
    QPushButton *openKomodoConfButton;
    ...
    void setupUi(QDialog *OptionsDialog)
    {
        ...
        komodoAtStartup = new QCheckBox(tabMain);
        komodoAtStartup->setObjectName(QStringLiteral("komodoAtStartup"));

        verticalLayout_Main->addWidget(komodoAtStartup);
        ...
        openKomodoConfButton = new QPushButton(OptionsDialog);
        openKomodoConfButton->setObjectName(QStringLiteral("openKomodoConfButton"));
        openKomodoConfButton->setAutoDefault(false);

        verticalLayout_Buttons->addWidget(openKomodoConfButton);
    ...
    void retranslateUi(QDialog *OptionsDialog)
    {
        ...
        komodoAtStartup->setToolTip(QApplication::translate("OptionsDialog", "Automatically start %1 after logging in to the system.", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        komodoAtStartup->setText(QApplication::translate("OptionsDialog", "&Start %1 on system login", Q_NULLPTR));
...
#ifndef QT_NO_TOOLTIP
        mapPortUpnp->setToolTip(QApplication::translate("OptionsDialog", "Automatically open the Komodo client port on the router. This only works when your router supports UPnP and it is enabled.", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
...
#ifndef QT_NO_TOOLTIP
        connectSocks->setToolTip(QApplication::translate("OptionsDialog", "Connect to the Komodo network through a SOCKS5 proxy.", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
...
#ifndef QT_NO_TOOLTIP
        connectSocksTor->setToolTip(QApplication::translate("OptionsDialog", "Connect to the Komodo network through a separate SOCKS5 proxy for Tor hidden services.", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
...
#ifndef QT_NO_TOOLTIP
        openKomodoConfButton->setToolTip(QApplication::translate("OptionsDialog", "Open the %1 configuration file from the working directory.", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        openKomodoConfButton->setText(QApplication::translate("OptionsDialog", "Open Configuration File", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
