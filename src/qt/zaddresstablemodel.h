...
public:
    ...
    enum ColumnIndex {
        isMine = 0,
        Balance = 1,
        Scope = 2,   /**< Ironwood IVK scope (External/Internal) */
     ...
     */
    QString addRow(const QString &type, const QString &label, const QString &address, bool useDiversified = false, const QString &addressType = QString());
