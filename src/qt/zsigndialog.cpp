...
void ZSignDialog::on_signButton_clicked()
{
    ...
    try
    {
      ...
      if (params.size() !=12)
      {
              ...
              "\nResult:\n"
              "\"sendrawtransaction\"   (string) A string containing the transaction data that can be pasted into the on-line wallet\n"
              "                                  to broadcast it to the network for processing.\n";
