...
extern UniValue rescan(const UniValue& params, bool fHelp, const CPubKey& mypk); // in rpcdump.cpp
...
extern UniValue z_exportironwooddisclosure(const UniValue& params, bool fHelp, const CPubKey& mypk); // in rpcwallet.cpp
extern UniValue z_verifyironwooddisclosure(const UniValue& params, bool fHelp, const CPubKey& mypk); // in rpcwallet.cpp
...
extern UniValue enablesaplingconsolidation(const UniValue& params, bool fHelp, const CPubKey& mypk); // in rpcwallet.cpp
extern UniValue enableironwoodconsolidation(const UniValue& params, bool fHelp, const CPubKey& mypk); // in rpcwallet.cpp
